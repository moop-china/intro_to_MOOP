...
1.  **MOOP为用户提供了创作和分享的平台。**
    ...
    MOOP鼓励用户进行内容的创作并贡献出来，每个人都可以创建自己的专题，并学习别人的专题，在专题之下进行讨论。
...
​    总而言之，如果你想有足够的计算性能，如果想在任何计算机上都可以随时访问自己的独有notebooks，如果不想自己去安装配置服务，如果想和别人进行交流，如果想快速地获取大量的免费notebook资源，那就使用MOOP吧！

### MOOP的板块体系

​    各行各业都可以在MOOP上找到自己的领域，和有共同兴趣的人们进行交流或者是独自探索。现在MOOP平台有以下的一些领域。
...
​    一个开放的平台，就需要亮点来吸引人们聚集。而MOOP平台的亮点就在于，提供了统一的云平台进行编程和内容的分享，并有相当程度的自定义空间。即，这是一个欢迎内容创作者和分享者的平台，MOOP提供了很大的空间来让创作者创建自己的专题。

​    一个内容平台的核心竞争力是内容本身。MOOP本身能提供的内容资源非常有限，任何一个平台都是如此，一个良好的社区是靠大家来共同维护和建造的，而不是靠社区管理员。作为一个新的内容平台，无可避免地要从无到有。就像一个黑洞，越吞越大才能更有吸引力。

​    MOOP拥抱共享开放的思想，同时尊重版权，如果有不想公开的内容，MOOP提供了私有的专题，只供内部使用。
